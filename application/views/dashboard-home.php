        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $this->reporte_model->cantidadCliente(); ?></h3>
                <h5>Clientes</h5>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">          
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $this->reporte_model->cantidadMarca(); ?></h3>
                <h5>Modelos</h5>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-tag"></i>
              </div>
              <a href="<?php echo base_url(); ?>index.php/marca/index" class="small-box-footer">Más Información
                <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">          
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $this->reporte_model->cantidadModelo(); ?></h3>
                <h5>Modelos</h5>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-tag"></i>
          ...
          <div class="col-lg-3 col-6">          
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $this->reporte_model->cantidadProducto(); ?></h3>
                <h5>Productos</h5>
              </div>
              <div class="icon">
